    ...
    <wyb-popup
      ...
      <view class="wyb-modal">
        ...
        <view class="wyb-modal-btns">
          <view :style="{transform: scaleLine}" class="wyb-modal-line"/>
            ...
            <view
              ...
              <view v-if="asyncClose&&confirmClick" class="wyb-modal-loading">
                <view :style="{
									 ...
									 transform: 'scale(0.5)'}" class="wyb-modal-loader"/>
              </view>
            </view>
          </view>
        </view>
...
<script>
import wybPopup from '@/components/third-party/wyb-popup/wyb-popup.vue'
