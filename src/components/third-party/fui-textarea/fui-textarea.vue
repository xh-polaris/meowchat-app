<template>
  <view
    :class="{ 'fui-textarea__border': textareaBorder }"
    :style="{ marginTop: marginTop + 'rpx', borderColor: borderColor }"
    @tap="fieldClick"
  >
    <view
      class="fui-textarea__wrap"
      :class="{ 'fui-textarea__flex-start': flexStart }"
      :style="{
    ...
    >
      ...
      <view
        class="fui-textarea__required"
        :class="{ 'fui-required__flex-start': flexStart }"
      ...
      <view
        ...
        :style="{ minWidth: labelWidth + 'rpx' }"
        v-if="label"
      >
        <text :style="{ fontSize: labelSize + 'rpx', color: labelColor }">{{
          label
        }}</text>
      </view>
      <slot name="left"></slot>
      <view class="fui-textarea__flex-1">
        <textarea
          class="fui-textarea__self"
          :class="{ 'fui-text__right': textRight }"
          :style="{
            height: height,
            minHeight: minHeight,
            fontSize: size + 'rpx',
          ...
          placeholder-class="fui-textarea-placeholder"
          :name="name"
          :value="val"
        ...
        <view class="fui-textarea__counter" v-if="isCounter">
          <text
            ...
            >{{ maxlength != -1 ? `${count}/${maxlength}` : count }}</text
          >
        </view>
      </view>
      <slot></slot>
      <view
        v-if="borderBottom && !textareaBorder"
        :style="{
          background: borderColor,
          left: bottomLeft + 'rpx',
          right: bottomRight + 'rpx',
        }"
        class="fui-textarea__border-bottom"
      ></view>
    </view>
  </view>
</template>
