<template>
	<view class="content">
		<!-- 搜索框 -->
		<view class="d-flex j-sb a-center border mx-4 px-2 mt-1"
			style="height: 80rpx;border-radius: 50rpx;border-color: #9FCCEB;">
			<view class="ml-1">
				<input v-model="searchCatPreviewsReq.keyword" class="search-text" maxlength="20" placeholder="搜索猫咪" />
			</view>
			<view style="">
				<image style="width: 50rpx;" class="mt-1" mode="widthFix" src="/static/images/search.png"
					@click="onClickSearch" />
			</view>
		</view>
		<!-- 校区选择框   -->
