<template>
	<view class="page">
		<view class="d-flex border a-center j-sb mx-2 mb-2" style="border-radius: 70rpx; height: 70rpx">
			<view class="d-flex a-center">
				<image class="ml-2" style="width: 40rpx" mode="widthFix" src="/static/images/search.png" />
				<input ref="getValue" v-model="searchText" class="search-text ml-2" maxlength="20"
					placeholder="搜索帖子|动态|图鉴" type="text" />
			</view>
