	...
	<view>
		...
		<view>
			<scroll-view scroll-x="true" class="scroll-view-item_H" scroll-left="120">
				<li v-for="(item, index) in cat.avatars" :key="index" class="img-li" @click="
            () => {
              (mainImgUrl = item), (imgActiveIndex = index);
            }
          ">
					<image :class="index === imgActiveIndex ? 'img_activeBorder' : ''" :src="item"
		...
		<view class="progress-box">
			...
			<view class="text-box2">
				<progress :percent="cat.popularity" :stroke-width="10" activeColor="#63A4F9" backgroundColor="#F5F5F5"
					border-radius="6px" />
		...
		<view class="photo">
			...
			<view class="dd">
				...
				<view v-if="spread" class="spread" @click="
            () => {
              spread = !spread;
            }
          ">
