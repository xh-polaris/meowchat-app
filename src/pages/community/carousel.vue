...
.slide {
  ...
  top: calc(($slideHeightLarge - $slideHeightSmall) / 2 + $verticalPaddingOfCarousel);
...
.slide-leftest {
  left: calc($horizontalMarginOfSlideCenter - ($slideWidthSmall + $slideGap) * 2);
  z-index: 0;
}
...
.slide-rightest {
  left: calc($horizontalMarginOfSlideCenter + ($slideWidthLarge + $slideGap) + ($slideWidthSmall + $slideGap));
  z-index: 0;
}
