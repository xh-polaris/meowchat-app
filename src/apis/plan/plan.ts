import { DeletePlanReq, DonateFishReq, GetPlanDetailReq, GetPlanDetailResp, GetPlanPreviewsReq, GetPlanPreviewsResp, GetUserFishReq, GetUserFishResp, ListFishByPlanReq, ListFishByPlanResp, NewPlanReq } from "./plan-interfaces";
